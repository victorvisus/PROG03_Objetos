...
public class Persona {
    ...
    public void main() {
        ...
        //Llama al método cambiaNombre() para asignar el valor introducido al atributo nombre de la clase Persona
        cambiaNombre(consulta.nextLine());

        //Solicita la edad para el objeto que se este construyendo.
        System.out.println("Introduce la edad:");
        //Llama al método cambiaEdad() para asignar el valor introducido al atributo nombre de la clase Persona
